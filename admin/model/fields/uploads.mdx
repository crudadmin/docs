...
To make all file fields of a model private, use [`$privateUploads`](/admin/model/uploads#private-files). Image compression, deleting old files and uploading from code are described in [Model uploads](/admin/model/uploads).
