...
{/* feature: frontend.window.crudadmin */}
...
Global components named `AppLogo` and `RightNavbarSlot` fill the logo and the top navbar. All places for your own components are listed in [Slots](/admin/frontend/slots).
