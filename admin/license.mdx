...
CrudAdmin is commercial software. It is not open source, and you need a valid license key to use it.
...
Without a valid license key, or without written permission of the author, you cannot:
