...
A license grants access to selected major versions of CrudAdmin. Composer lists only the versions your license includes.

### CrudAdmin 5

CrudAdmin 5 stays under the MIT license and is free. It is installed from the same repository, with a free license for CrudAdmin 5. To get it, contact [sales@gogoldev.com](mailto:sales@gogoldev.com).

```bash
composer require crudadmin/crudadmin:^5.0
```
