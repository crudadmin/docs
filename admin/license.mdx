...
CrudAdmin is commercial software licensed by Gogol Development s.r.o. It is not open source, and you need a valid license key to use it.
...
Without a valid license key, or without written permission of Gogol Development s.r.o., you cannot:
